...
function Projects({}: Props) {
  ...
  return (
    ...
    >
      ...
      scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb[#815af5]/80"
      >
        <div
        ...
        >
          <motion.img
            ...
            className="border border-gray-500 w-[auto] h-[400px]"
          />
      ...
      <div className="w-full absolute top-[30%] bg-[#815af5]/10 left-0 h-[500px] -skew-y-12" />
    </motion.div>
  );
}
